...
/* 滑走路は 2 本。2 機ずつ並んで離陸するため（ブルーインパルスの離陸にならう）。
   1 本目は原点（x=0）、2 本目は西側。地上の並びは 2 本に 2 機ずつ、3 列 */
const RWY2 = -100;                               // 2 本目の滑走路の位置（m）
const RWY_X = [0, RWY2];
const GRID = [[0, 0], [RWY2, 0], [0, -46], [RWY2, -46], [0, -92], [RWY2, -92]];   // 1〜6 番機（1 番機の位置からのずれ）
