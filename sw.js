...
const CACHE = 'aat-v02-2';   // 表示する版は同じでも、配信のたびに名前を変える（末尾の連番）
const ASSETS = ['./', './index.html', './engine.js?v=36', './viewer.js?v=3', './sim3d.js?v=12', './manifest.webmanifest', './privacy.html', './news.json',
